...
<h2 >DK Manager</h2>
<p>Here you can configure sync and other settings.</p>
    
<p><strong>Current Time: </strong><?php echo date( 'H:i:s Y-m-d ', strtotime( current_time('mysql') ) ); ?></p>

<hr>
<h3 class="dot_head">Price Sync Settings</h3>
<input type="checkbox" id="dot_price_update_enabled" <?php echo $dot_price_update_enabled; ?> value="enabled">Enable product price sync from DK to WooCommerce</input><br>
<div style="display: flex; align-items: center; gap: 8px;">Check for price updates in DK every 
...
<p><strong>Last price sync performed: </strong><?php echo $dot_last_sync ? $dot_last_sync: 'No sync performed' ?></p>
<p><strong>Next price sync scheduled: </strong><?php echo $dot_next_sync ? $dot_next_sync: 'No sync scheduled' ?><p>
<hr>

<h3 class="dot_head">WooCommerce to DK product creation</h3>
<input type="checkbox" id="dot_w2dk_product_enabled" <?php echo $dot_w2dk_product_enabled; ?> value="enabled">Create a new product in DK when a new product is added in WooCommerce</input><br>
<br>
...
<h3 class="dot_head">Enable customer kennitala lookup button</h3>
<input type="checkbox" id="dot_customer_lookup_enabled" <?php echo $dot_customer_lookup_enabled; ?> value="enabled">Enable the kennitala lookup button during checkout</input>
<br><br>
<div style="display: flex; align-items: center; gap: 8px;">
...
<div class="dot_row dot_gap_50 dot_pr-50 dot_br-1">
    <div>
        ...
        <h3 class="dot_head">Product sync - DK to WooCommerce</h3>
        <p>Click the button below to initiate product sync</p>
        <p>Only those products that do not currently exist in WooCommerce will be synced from DK.</p>
        <div>
            <div style="margin-bottom: 10px;">
            ...
            <div style="margin-bottom: 10px;">
                <input type="checkbox" id="dot_dk_products_fetch_in_batches_enabled" value="enabled" checked disabled>Fetch Products in Batches of </input><input type="number" min=2 max=100 value="2" id="dot_dk_products_fetch_in_batches"> items.<br>
                <input type="checkbox" id="dot_dk_products_fetch_batches" value="enabled" checked disabled>Total No. of Batches </input><input type="number" value="" min=2 max="500" id="dot_dk_products_fetch_batches_no"><br>
